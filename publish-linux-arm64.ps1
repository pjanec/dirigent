...
dotnet publish src\Dirigent.Agent.Console\Dirigent.Agent.Console.csproj -f net8.0 -r linux-arm64 --self-contained true -o publish\Dirigent.Agent.Console\linux-arm64\$buildconf
